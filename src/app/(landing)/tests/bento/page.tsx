    ...
    <div>
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-8 sm:gap-20">
          ...
          <div className="grid gap-4 max-lg:grid-cols-1 max-lg:grid-rows-8 lg:grid-cols-4 lg:grid-rows-4">
            {/* first bento grid element */}
            <div className="relative lg:row-span-2 max-lg:row-start-1">
              <div className="absolute inset-px rounded-lg bg-white lg:rounded-l-[2rem] max-lg:rounded-t-[2rem]" />{/*max-lg:rounded-t-[2rem] */}
            ...
            <div className="relative max-lg:row-start-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[theme(borderRadius.lg)+1px]">
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="pointer-events-none absolute inset-px rounded-lg shadow ring-1 ring-black/5 max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]" />{/*lg:rounded-r-[2rem] lg:rounded-r-[calc(2rem+1px)]*/}
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
